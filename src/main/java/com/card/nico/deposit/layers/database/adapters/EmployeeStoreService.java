...
@Component
class EmployeeStoreService implements EmployeeStore {
    ...
    EmployeeStoreService(EmployeeRepository employeeRepository, EmployeeEntityConverter employeeEntityConverter, CompanyEntityConverter companyEntityConverter) {
