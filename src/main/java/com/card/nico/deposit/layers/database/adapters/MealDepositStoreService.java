...
@Component
class MealDepositStoreService extends MealDepositStore {
    ...
    MealDepositStoreService(MealDepositRepository mealDepositRepository, MealDepositEntityConverter mealDepositEntityConverter) {
